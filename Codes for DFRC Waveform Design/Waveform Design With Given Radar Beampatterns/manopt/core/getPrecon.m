...
% function Pd = getPrecon(problem, x, d, storedb, key)
%
% Returns as Pd the result of applying the Hessian preconditioner to the tangent vector d at point x. The preconditioner is supposed to be a
% symmetric, positive definite approximation of the inverse of the Hessian.
% 
% If no preconditioner is available, Pd = d (identity). storedb is a StoreDB object, key is the StoreDB key to point x.
% See also: getHessian

% This file is part of Manopt: www.manopt.org. Original author: Nicolas Boumal, Dec. 30, 2012.
% Contributors:  Change log:    April 3, 2015 (NB):     Works with the new StoreDB class system.
